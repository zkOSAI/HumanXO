...
export async function depositTokens(level: DepositLevel): Promise<DepositResult> {
    try {
        // Validate environment variables
        const tokenAddress = getRequiredEnvVar("NEXT_PUBLIC_TOKEN_ADDRESS") as EthAddress;
        const contractAddress = getRequiredEnvVar("NEXT_PUBLIC_CLAIM_CONTRACT") as EthAddress;
